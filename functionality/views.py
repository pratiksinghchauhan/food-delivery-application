  ...
  "route": [
    ...
    },
    {
      ...
      "station": {
        ...
        responseText = "Alright We got your order, "+ "if the train reaches on time you will get order on "+ deliveryDay + " between "+ values["scharr"] + " and " + values["schdep"] + " ,dont worry we will keep tracking the status, you will be notified before 30 minutes of order delivery."
        print responseText
